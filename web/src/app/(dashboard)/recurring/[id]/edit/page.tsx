...
export default function EditRecurringExpensePage() {
    ...
    return (
        <div className="max-w-2xl mx-auto">
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight mb-2">Editar Transação Recorrente</h1>
                <p className="text-slate-500 dark:text-slate-400">Atualize os detalhes do seu compromisso mensal fixo.</p>
            </div>
